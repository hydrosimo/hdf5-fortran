...
PROGRAM main
  ...
  CHARACTER(LEN=16), PARAMETER :: filename   = "group-noref.h5"
  ...
  integer :: rankr, ii, jj
  integer(INT32), dimension(1,1) :: a, c, d
  ...
  call h5dcreate_f(group2, dsetname4, H5T_NATIVE_INTEGER, dataspace4, &
