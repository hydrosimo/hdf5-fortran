...
character(len=20), parameter :: filename1 = "mat.h5" ! File name
...
integer(hsize_t) :: dim_value = 15811
...
dimsf = (/dim_value, dim_value/)
data_dims = (/dim_value, dim_value/)
allocate(buf1(dim_value, dim_value))
